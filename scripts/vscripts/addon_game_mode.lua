...
function Precache( context )
    ...
    --Cache new particles
		...
		PrecacheResource( "particle", "particles/batrider_ti8_immortal_firefly_path.vpcf", context )
		PrecacheResource( "particle", "particles/phantom_assassin_stifling_dagger.vpcf", context )
		PrecacheResource( "particle", "particles/phantom_assassin_stifling_dagger_debuff.vpcf", context )
		PrecacheResource( "particle", "particles/brewmaster_drunken_brawler_crit.vpcf", context )
		PrecacheResource( "particle", "particles/brewmaster_drunkenbrawler_evade.vpcf", context )
		PrecacheResource( "particle", "particles/sniper_assassinate.vpcf", context )
		PrecacheResource( "particle", "particles/templar_assassin_refraction.vpcf", context )
		PrecacheResource( "particle", "particles/ursa_earthshock.vpcf", context )
		PrecacheResource( "particle", "particles/ursa_enrage_buff.vpcf", context )
		PrecacheResource( "particle", "particles/alchemist_lasthit_coins.vpcf", context )
	...
	--Cache sounds for traps
		...
		PrecacheResource( "soundfile", "soundevents/bomj_otrijka.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/bomj_zabuhal.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/lion_avada.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/lion_duro.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/lion_snake.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/naruto_jutsu.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/naruto_kva.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/naruto_priziv.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/naruto_rasengan.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/rubick_patronum.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/rubick_plash.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/rubick_zaebal.vsndevts", context )
		PrecacheResource( "soundfile", "sounds/otrijka.vsnd", context )
		PrecacheResource( "soundfile", "soundevents/z_force.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/lion_stons.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/z_sange.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/gonshik_cep.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/gonshik_ad.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/z_oprivet.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/sniper_shot.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/sniper_mlg.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/sniper_meld.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/chubaka_rik.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/chubaka_chubaka.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/finish_him.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/scorpion_getoverhere.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/scorpion_fatality.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/scorpion_duel.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/gameend.vsndevts", context )
