...
function modifier_huskar_berserkers_blood_lua:IsHidden()			return true 
end
...
function modifier_huskar_berserkers_blood_lua:OnCreated()
	-- Variables
	self.berserkers_blood_hp_regen = self:GetAbility():GetSpecialValueFor( "hp_regen_per_stack" )
...
function modifier_huskar_berserkers_blood_lua:GetModifierHealthRegenPercentage ( params )
	return self:GetStackCount() * self.berserkers_blood_hp_regen
end
